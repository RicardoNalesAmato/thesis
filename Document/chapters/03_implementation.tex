...
Based on \parencite{cvss3} we have the following table:
...
Once we had all of the previous parts developed, we set out to develop a learning function that would:
