              ...
              <Row>
                ...
                <Col xs={8} md={8}>
                  <Thumbnail src='/assets/images/tutorial2.png' alt='242x200'>
                    ...
                    <p>
                      ...
                      You can move all nodes around, in case you want to focus in just one subsection of it. Each node's color represents the severity of the bug found in it.
                    </p>
                  </Thumbnail>
                </Col>
                <Col xs={8} md={8}>
                ...
                <Col xs={12} md={12}>
                  <Thumbnail src='/assets/images/tutorial4.png' alt='242x200'>
                    ...
                    <p>
                      We will show you (if there is a bug in a specific node) the CVSS3 base scores for it, which have been automatically generated by us. Please change anything that you think is wrong.
                    </p>
                  </Thumbnail>
                </Col>
                <Col xs={12} md={12}>
